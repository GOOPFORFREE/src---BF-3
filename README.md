...
Cr:Label("Credit : GOOP HUB")
Cr:Line()
Cr:Label("ร้าน : CHEEL SHOP")
Cr:Line()
Cr:Label("คนทำ : Dr.xxx#9999")
Cr:Line()
Cr:Button("Copy Link github",function()
    setclipboard("https://github.com/a08630167371")
end)
